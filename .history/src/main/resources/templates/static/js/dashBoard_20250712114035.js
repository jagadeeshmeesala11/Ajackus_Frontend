...
applyBtn.addEventListener('click', () => {
  const filteredEmployees = currentEmployees.filter(employee => employee.firstName.toLowerCase() === firstNameInput.value.toLowerCase() && employee.department === departmentInput.value && employee.role === roleInput.value);
  renderDashboard(filteredEmployees);
});
