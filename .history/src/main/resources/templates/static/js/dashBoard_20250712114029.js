...
applyBtn.addEventListener('click', () => {
  const filteredEmployees = currentEmployees.filter(employee => employee.firstName.toLowerCase() === firstNameInput.value && employee.department === departmentInput.value && employee.role === roleInput.value);
  renderDashboard(filteredEmployees);
});
