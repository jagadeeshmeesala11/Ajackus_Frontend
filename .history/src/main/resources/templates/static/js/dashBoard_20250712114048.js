...
applyBtn.addEventListener('click', () => {
  const filteredEmployees = currentEmployees.filter(employee => employee.firstName.toLowerCase() === firstNameInput.value.toLowerCase() && employee.department.toLowerCase() === departmentInput.value.toLowerCase() && employee.role.toLowerCase() === roleInput.value);
  renderDashboard(filteredEmployees);
});
